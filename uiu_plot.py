...
question_groups = {
    'I made the sketch vs The system made the sketch': ['I made the sketch vs The system made the sketch'],
    "I'm very unsatisfied with the sketch vs I'm very satisfied with the sketch": ["I'm very unsatisfied with the sketch vs I'm very satisfied with the sketch"],
    'The sketch was what I was aiming for vs The sketch outcome was unexpected': ['The sketch was what I was aiming for vs The sketch outcome was unexpected'],
    'The sketch is a very typical vs The sketch is a very novel': ['The sketch is a very typical vs The sketch is a very novel'],
    'I was able to effectively communicate what I wanted to the system.': ['I was able to effectively communicate what I wanted to the system.'],
    'I was able to steer the system towards output that was aligned with my goals.': ['I was able to steer the system towards output that was aligned with my goals.'],
    'At times, I felt that the system was steering me towards its own goals.': ['At times, I felt that the system was steering me towards its own goals.'],
    'At times, it felt like the system and I were collaborating as equals.': ['At times, it felt like the system and I were collaborating as equals.'],
    'ENJOYMENT': [
        'I would be happy to use this system or tool on a regular basis.',
        'I enjoyed using the system or tool.'
    ],
...
for qg, question_group in enumerate(question_groups):
    ...
    for splitter in splitters:
        ...
        fig.add_trace(go.Bar(x=[0], y=[' ' if option==splitters[splitter][1] else ''], orientation='h', marker={'color':colors}))

    fig.add_vline(x=M)
    fig.update_layout( barmode='stack', showlegend= False, margin=dict(l=20, r=20, t=50, b=20), title=question_group, height=300, width=1000, font={'size':20})
    fig.update_xaxes(range=[0,2*M], showgrid=False, visible=False)
    # fig.show()
    fig.write_image(f'out/q{qg+1}.png')
